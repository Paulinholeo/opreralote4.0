...
class CTkScrollableDropdownFrame(customtkinter.CTkFrame):
    ...
    def __init__(self, attach, x=None, y=None, button_color=None, height: int = 200, width: int = None,
        ...
        self.dummy_entry = customtkinter.CTkEntry(self.frame, fg_color="transparent", border_width=0, height=1, width=1, placeholder_text='Escolha')
        self.no_match = customtkinter.CTkLabel(self.frame, text="Escreva")
        self.height = height
        ...
        if double_click or self.attach.winfo_name().startswith("!ctkentry") or self.attach.winfo_name().startswith("!c"):
